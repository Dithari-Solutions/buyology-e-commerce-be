 ...
 *
 * EXPRESS_DELIVERY  — fulfilled by a local courier, typically within 30 minutes.
 *                     Courier updates are GPS-tracked in OrderTrackingEvent.
 *
 * REGULAR_ORDER     — standard local delivery for distances > 30 minutes within the same country.
 */
