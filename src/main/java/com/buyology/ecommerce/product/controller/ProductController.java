...
public class ProductController {
    ...
    @RequestBody(
            ...
            content = @Content(
                    ...
                    schema = @Schema(implementation = ProductController.CreateProductForm.class),
    ...
    /**
     * Documentation-only schema for Swagger UI.
     * Describes the multipart/form-data shape: a JSON request part and an optional binary file array.
     */
