...
public class ProductSpecOption {
    ...
    public ProductSpecOption(ProductSpecGroup group, GlobalSpecOption globalSpecOption, String value, SpecUnit unit) {
        this.group = group;
    ...
    public ProductSpecOption(ProductSpecGroup group, String value, String colorCode) {
        this.group = group;
        this.value = value;
